      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            >En base a la experiencia de los Profesionales que conforman Tecnología Universal estamos en la capacidad de intervenir en:</p>
          </div>
        </div>
        <div class="row aling-items-center">
          <div class="col-lg-6">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="@/assets/img/about/1.jpg" alt />
              <p
                class="text-muted"
              >Mantenimientos correctivos, preventivos y predictivos de plantas industriales.</p>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="team-member">
              ...
              <p
                class="text-muted"
              >Elaboración y ejecución de proyectos eléctricos, y automatización industrial dirigidos a plantas industriales.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              ...
              <p>Reparación y mantenimiento de motores eléctricos AC y DC.</p>
              <p>Mantenimiento de sistemas de bombeo, sistema de presión constante y equipos hidroneumáticos.</p>
              <p>Fabricación, reparación y mantenimiento de trasformadores y subestaciones.</p>
              <p>Mantenimiento preventivo y correctivo de grupos electrógenos.</p>
              <p>Instalación y mantenimiento de sistema de puesta a tierra.</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              ...
              <p>
                Mantenimiento de UPS, estabilizadores de voltaje, Inversores, luces de emergencia.
                Mantenimiento y reparación de sistemas neumáticos e hidráulicos (cilindros, reguladores y bombas).
              </p>
            </div>
          </div>
        </div>
